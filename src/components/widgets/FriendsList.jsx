...
const FriendsList = () => {
    ...
    return (
        <div className="bg-white rounded-xl p-4 shadow-sm h-screen sticky top-0">
            ...
            <h3 className="font-semibold text-lg mb-2">Stories</h3>
            ...
            <ul className="space-y-3 overflow-y-auto" style={{ height: 'calc(100vh - 220px)' }}>
                {friends.map((friend) => (
